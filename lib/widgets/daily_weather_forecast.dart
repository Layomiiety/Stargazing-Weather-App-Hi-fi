          ...
          children: [
            Container(
              ...
              child: const Text(
                "Next Days",
                style:
                    TextStyle(color: CustomColors.textblackcolor, fontSize: 17),
              ),
            ),
            dailyList(),
          ],
  ...
  Widget dailyList() {
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemCount: weatherDailyData.daily.length > 7
            ? 7
            ...
            Container(
              ...
              child: Row(
                  ...
                  children: [
                    SizedBox(
                      width: 80,
                      child: Text(getDay(weatherDailyData.daily[index].dt),
                          style: TextStyle(
                    ...
                    SizedBox(
                      ...
                      width: 30,
                      child: Image.asset(
                          "assets/weather/${weatherDailyData.daily[index].weather![0].icon}.png"),
                    ),
                    /* Text(
                    "${weatherDailyData.daily[index].temp!.max}°/${weatherDailyData.daily[index].temp!.min}°",
                  ) */
                    Text(
                      "${Preferences.getTempInUnits(weatherDailyData.daily[index].temp!.max!)} / ${Preferences.getTempInUnits(weatherDailyData.daily[index].temp!.min!)}",
                    )
                  ]),
            ),
            Container(
